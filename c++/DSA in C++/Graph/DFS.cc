...
//         }
//     }
//     void dfs(unordered_map<char,bool>&visited,vector<char>&ans,char node){
//         ans.push_back(node);
//         visited[node]=1;
...
//     }
//     int m;
//     cout<<"Enter no. of edges for directed graph: ";
//     cin>>m;
//     for(int i=0;i<m;i++){
//         char u;
//         char v;
...
//     vector<char>ans;
//     ans=g.DFS();
//     cout<<"DFS travesal of given graph by taking "<<g.vertices[0]<<" as source node: ";
